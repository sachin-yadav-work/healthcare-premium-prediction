...
def calculate_normalized_risk(medical_history):
    ...
    norm_risk_score = (total_risk_score - min_score) / (max_score - min_score)

    return norm_risk_score

def preprocess_input(input_dict):
    # Define the expected columns and initialize the DataFrame with zeros
    expected_columns = [
        'age', 'number_of_dependants', 'income_lakhs', 'insurance_plan', 'genetical_risk', 'norm_risk_score',
    ...
    # Assuming the 'norm_risk_score' needs to be calculated based on the 'age'
    df['norm_risk_score'] = calculate_normalized_risk(input_dict['Medical History'])
